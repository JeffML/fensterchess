...
async function loadFromToIndex() {
  if (!fromToIndexCache) {
    ...
    try {
      ...
      console.warn('Failed to load local file, falling back to GitHub:', err.message);
    }
...
export const handler = async (event) => {
  ...
  try {
    ...
    // Load fromToPositionIndexed for finding continuations (from eco.json repo)
    const fromToIndexed = await loadFromToIndex();
