...
export const MEDIUM_INTERPOLATED2 =
  "https://medium.com/@jefflowery/navigating-chess-openings-part-2-408a488d919b";
export const WIKI_THEORY = "https://en.wikibooks.org/wiki/Chess_Opening_Theory";
export const WIKI_THEORY_API =
  "https://en.wikibooks.org/w/api.php?titles=Chess_Opening_Theory/";
export const WIKI_THEORY_API_QS =
  "&redirects&origin=*&action=query&prop=extracts&formatversion=2&format=json&exchars=1200";
...
export const DISCUSSION =
  "https://github.com/JeffML/fensterchess/discussions/1";
